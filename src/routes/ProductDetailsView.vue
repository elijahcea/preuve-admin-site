...
<template>
    <div class="w-2xl flex flex-col m-auto items-center gap-5">
        <div class="flex items-center justify-start w-full gap-3">
            ...
            <div :class="['rounded-2xl border p-1 text-xs', productStatus ? 'border-blue-300 bg-blue-300 text-blue-900' : 'border-gray-300 bg-gray-300 text-gray-900']">{{ productStatus ? "Active" : "Draft" }}</div>
        </div>
        <form class="w-full text-sm flex flex-col gap-5">
            ...
            <fieldset class="bg-background rounded shadow-lg p-3 min-w-0">
                ...
                >
                    ...
                    <ListboxButton class="relative border border-gray-300 rounded p-2 w-full flex items-center justify-between my-1">
                    ...
                    <div class="relative mt-1">
                        ...
                        >
                            <ListboxOptions class="absolute z-50 w-full bg-background shadow-lg rounded border border-gray-300">
